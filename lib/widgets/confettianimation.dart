...
class _ConfettiScreenState extends State<ConfettiScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...confetti.map((c) {
            return Positioned(
              left: MediaQuery.of(context).size.width / 2 + cos(c.angle) * c.distance,
              top: MediaQuery.of(context).size.height / 2 + sin(c.angle) * c.distance,
