...
DateTime selectedDateBB = DateTime.now();
String MatchNameBB = "";
List<String> normals = ["Team A", "Team B"];
String Shooter = "";
int points = 0;
int Fouls = 0;
String ShootingTeam = "";
...
Future createUser(String name) async {
  if (name == "Cricket") {
    String Balls = "Ball${Ball}";

    String selectedDate2 = selectedDate.toString();
    selectedDate2 = selectedDate2.replaceAll('-', ' ');
    ...
    if (firstTime) {
      ...
      await ref2.update(json2);
    }
  } else if (name == "BasketBall" || name == "FootBall") {
    String selectedDate2 = selectedDateBB.toString();
    selectedDate2 = selectedDate2.replaceAll('-', ' ');
    if (firstTime) {
      DatabaseReference ref1 =
      ...
      time2 = time2.replaceAll('.', ' ');
      DatabaseReference ref2 = FirebaseDatabase.instance
          .ref('Sports/$name/$MatchNameBB/Stats/$time2');

      final json2 = {
        "Shooting Team": ShootingTeam,
        "Shooter": Shooter,
        "Points": points,
        "Fouls": Fouls
      };
